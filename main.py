...
if __name__ == "__main__":
    ...
    parser.add_argument('--start', type=int, default=2015, help='Specify start year for publication date range to scrape. Default = 2019')
    parser.add_argument('--stop', type=int, default=2023, help='Specify stop year for publication date range to scrape. Default = 2020')
